...
class Categoria extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('NomeCategoria', 'required'),
			array('NomeCategoria', 'length', 'max'=>90),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idCategoria, NomeCategoria', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'projetos' => array(self::MANY_MANY, 'Projeto', 'projetocategoria(categoria_idCategoria, projeto_idprojeto)'),
		);
	}
